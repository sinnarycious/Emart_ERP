...
<body>
	<section class="loginPage">
		...
		<form action="${pageContext.request.contextPath}/member/memberLogin.do"
			...
			<fieldset class="login_form">
				...
				<div class="pw_area">
					<input type="text" name="userPwd" placeholder="비밀번호를 입력해주세요.">
				</div>
				<div class="idSave_checkbox">
					<input type="checkbox"> <label for="login_chk">아이디
						저장</label> <a href="#">아이디 찾기 / 비밀번호 찾기</a>
				</div>
	...
	<div class="copyrightText">
		<hr>
		<h5>프로젝트 참여원</h5>
		<p style="text-align: center;">copyright © 2021 Sinnarycious All Rights Reserved</p>
	</div>
